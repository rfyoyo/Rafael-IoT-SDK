...
macro(sdk_generate_library)
  ...
  # message("[register library : ${library_name}], path: ${CMAKE_CURRENT_LIST_DIR}")
...
macro(setup_project name)
  ...
  message("Binary files generate at ${build_dir}")
...
if (TARGET app)
    ...
    target_link_libraries(${proj_name}.elf -Wl,--whole-archive ${SDK_LIBS_PROPERTY} -Wl,--no-whole-archive)
endif()
