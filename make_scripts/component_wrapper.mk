...
-include $(RAFAEL_IOT_SDK_PATH)/make_scripts/project_val.mk
include $(COMPONENT_MAKEFILE)

ifeq ($(filter $(COMPONENT_NAME),$(CONFIG_LOG_ENABLED_COMPONENTS)),$(COMPONENT_NAME))
CPPFLAGS += -DCFG_COMPONENT_LOG_ENABLE=1
else
CPPFLAGS += -DCFG_COMPONENT_LOG_ENABLE=0
endif
...
$(subst $(RAFAEL_IOT_SDK_PATH),$$(RAFAEL_IOT_SDK_PATH),$(subst $(PROJECT_PATH),$$(PROJECT_PATH),$(subst $(BUILD_DIR_BASE),$$(BUILD_DIR_BASE),$(1))))
endef
...
# ie put literal $(RAFAEL_IOT_SDK_PATH), $(PROJECT_PATH) and $(BUILD_DIR_BASE) into the generated
